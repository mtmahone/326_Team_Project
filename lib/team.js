 ...
 */
function member(user, fname, lname, year, img) {
	return {
		user: user,
		fname: fname,
		lname: lname,
...
var team = [
	...
	member('cafonso', 'Christopher', 'Afonso', 'junior', '/img/rsz_chris.png'),
	member('mmahoney', 'Matthew', 'Mahoney', 'senior', '/img/rsz_matthew.png'),
	member('cwongwajarachot', 'Charlie', 'Wongwajarachot', 'senior', '/img/rsz_charlie.png'),
	member('qwang', 'Qiwen', 'Wang', 'senior', '/img/rsz_qiwen.png'),
	member('swang', 'Senh', 'Wang', 'senior', '/img/rsz_wang.png')
];
...
/*	var mem2 = member
    ...
    var temp = member.constructor();
    for (var key in member) {
        temp[key] = copy(member[key]);
    }
